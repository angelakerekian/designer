...
jQuery(function($) {
    ...
    jQuery.switcher = function(element, options) {
        ...
        var defaults = {
            pane: 'right',
            presetLinker: 'lgx-switcher-preset-linker',
    ...
    jQuery.extend( jQuery.switcher.prototype, {
        __init: function() {
            ...
            if ( false != self.defaultOptions.bgImageThumb ) {
                self.switcherHtml.push( '<div class="lgx-option-section">' );//background image/color option section
...
jQuery( document ).ready( function($) {
    ...
    if ( $( '.lgx-switcher-loader').length ) {
        ...
        $( '.lgx-switcher-loader' ).switcher( {
            ...
            /*FOR COLOR*/
            colorCssPath: 'switcher/css/color',
            color: {
                'switcher-color-default': '#2ecb71',
                'switcher-color-blue': '#3498db',
                'switcher-color-red': '#EF5350',
                'switcher-color-olive': '#77c043',
                'switcher-color-orange': '#FFBB33',
                'switcher-color-violet': '#9b36cd',
                'switcher-color-grey': '#607D8B',
                'switcher-color-pink': '#F06292'
            },

            /*FOR BG*/
            imagePath: './switcher/img/patterns/new',
            bgCssPath: 'switcher/css/bg',
            bgImageThumb: {'switcher-bg-three': 'pattern2.jpg', 'switcher-bg-four': 'pattern3.jpg', 'switcher-bg-two': '#fff', 'switcher-bg-one': 'pattern1-box.jpg'},
            ...
            layout: [
                {
                    image: 'dark.png',
                    link: 'http://themearth.com/demo/cvhunt/html/index-dark.html'
                },

                {
                    image: 'topmenu.png',
                    link: 'http://themearth.com/demo/cvhunt/html/index.html'
                },

                {
                    image: 'leftmenu.png',
                    link: 'http://themearth.com/demo/cvhunt/html/index-leftmenu.html'
                },

                {
                    image: 'rightmenu.png',
                    link: 'http://themearth.com/demo/cvhunt/html/index-rightmenu.html'
                }
            ]
        } );
    }
    ...
    /********************************************* CALL SWITCHER PLUGIN *************************************************************/
    if ( $( '.lgx-switcher-loader-left').length ) {

        $( '.lgx-switcher-loader-left' ).switcher( {
